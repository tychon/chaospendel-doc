...
\begin{figure}[Hbt]
  \centering
  \includegraphics[width=0.8\textwidth]{charts/pendulumsketch.png}
...
\begin{figure}[bht]
  \centering
  \includegraphics[width=0.8\textwidth]{charts/circuit_dia.png}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.8\textwidth]{images/tracker-white.png}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.8\textwidth]{images/prediction-white.png}
