...
Ein typischer labiler Zustand ist es zum Beispiel, wenn das Pendel mit einem sehr geringen Impuls fast senkrecht nach oben zeigt.
...
Interessant ist, dass die Systeme eigentlich deterministisch sind, und durch die Startbedingungen der weitere Verlauf vollständig berechnet werdn könnte.
Allerdings führen Messfehler und Ungenauigkeiten in der Berechnung zu Fehlern an genau den labilen Zuständen.
So weicht eine Simulation meist schnell von der Realität ab.
...
\begin{figure}[bht]
  ...
  \caption{Zeichnung der Pendelarme zur Bedeutung der Längenangaben \TODO winkel}
...
Hier sind die Formeln für die Berechnung der Energien, die später auch in der Simulation gezeigt werden, und die durch die Konstanten $k_1$ bis $k_5$ verallgemeinert sind. $T$ und $V$ sind die kinetische und die potentielle Energie:
...
\subsection{Simulation mit Haskell \TODO C}
