...
Nun werden auf der rechten Seite der Gleichungen für $\dot{p}_1$ und $\dot{p}_2$ noch $\phid_1$ und $\phid_2$ durch die rechte Seite der ersten zwei Gleichungen ersetzt, um eine \TODO Form für die Berechnung mithilfe des Runge"=Kutta"=Verfahrens zu erreichen.
...
Außerdem ist zu beobachten, dass höhere Frequenzen periodisch verschwinden und kurz danach wieder auftauchen, aber ein wenig kleiner.
