...
(\TODO soll das hier wirklich stehen? hmm, eher nicht, denke ich) Aus Gründen der Praktikabilität wollen wir diese Konstanten nicht
durch Längenmessungen am Pendel ermitteln, sondern kalibrieren.
...
Nachdem die Winkel und ihre Fourier"=Transformation (\TODO Plural?) berechnet sind, werden die Daten angezeigt.
