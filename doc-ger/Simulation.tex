...
k1 &= 0,0284 & k2 &= 0,118 & k3 &= 0,488 & k4 &= 0,00441 & k5 &= 0,0254
\mathematikstop
...
\begin{figure}
  ...
  \caption{Frequenzanalysen bei verschiedenen Starbedingungen. (Erklärung siehe Text)}
...
Dabei wird auf jeder Achse einer der drei wichtigen Freiheitsgrade $\phi_1$, $\phi_2$ und $p_2$ abgetragen.
