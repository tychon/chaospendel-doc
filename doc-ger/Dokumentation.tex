...
Zu dem fertigen Modell haben wir Bewegungsgleichungen aufgestellt und in ein Programm umgesetzt, das in der Lage ist, die Bewegung des Doppelpendels numerisch zu simulieren. Mithilfe dieses Programms haben wir dann viele Durchläufe simuliert und die Ergebnisse zu Grafiken umgewandelt, wodurch wir fraktal aussehende Muster und mögliche Attraktoren entdeckt haben.
\end{abstract}
\thispagestyle{empty}
\pagestyle{empty}
